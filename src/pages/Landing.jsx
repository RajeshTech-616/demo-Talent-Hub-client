            ...
            <Wrapper ref={heroRef}>
                <div className="hero-content">
                    <div className="text-content">
                        <h1>
                            Discover,Showcase & Monitize your <span className="fancy">Hidden Talents </span> 
                            
                        </h1>
                        <p>
                        Join thousands of extraordinary individuals who are turning their unique abilities into opportunities. Your talent deserves recognition and reward.
                        </p>

...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 mt-10 bg-gradient-to-r from-black via-gray-900 to-black text-white pb-2 pt-5 lg:pt-[30px]">
"
        <div className="container max-w-6xl mx-auto">
          <div className="flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-15w-full">
